...
| `servicemesh3operator-istio-version` | Istio version for all components | `v1.28.4` |
...
servicemesh3operator-channel: 'stable-3.2'
...
# servicemesh3operator-istio-version: 'v1.29.0'  # Optional: pin version
```
