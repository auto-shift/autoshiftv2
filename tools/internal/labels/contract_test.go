	...
	declared := map[string]*Declared{
		"ok-key": {
			...
			Declarations: []Declaration{
				{Key: "ok-key", File: "_example-hub.yaml", FromExample: true},
			},
		},
		"orphaned-key": {
			Key: "orphaned-key",
			Declarations: []Declaration{
				{Key: "orphaned-key", File: "_example-hub.yaml", FromExample: true},
			},
		},
	}
...
func TestBuildReport_AllowlistDowngrades(t *testing.T) {
	...
	declared := map[string]*Declared{
		"exempt-orphan": {
			Key: "exempt-orphan",
			Declarations: []Declaration{
				{Key: "exempt-orphan", File: "_example-hub.yaml", FromExample: true},
			},
		},
	}
	allow := &Allowlist{
